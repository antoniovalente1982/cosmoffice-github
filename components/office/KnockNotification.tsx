...
function IncomingKnockCard({
    ...
    return (
        ...
        >
            <div className="bg-[#0c1222] border border-cyan-500/30 rounded-2xl p-4 shadow-2xl shadow-cyan-500/10">
                {/* Header */}
...
function OutgoingKnockStatus({
    ...
    return (
        ...
        >
            <div className={`border rounded-2xl px-5 py-3 shadow-2xl flex items-center gap-3 bg-[#0c1222] ${config.color}`}>
                {config.icon}
                <div>
