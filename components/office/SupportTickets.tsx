...
export default function SupportTickets({ isOpen, onClose, workspaceId, embedded = false }: SupportTicketsProps) {
        ...
        <>
                ...
                {!selectedTicket ? (
                    ...
                    <div className="flex flex-col h-full">
                        <div className="flex items-center gap-2 p-3 border-b border-white/5">
                            ...
                            <div className="flex-1 min-w-0">
                                <h3 className="text-xs font-bold text-white truncate">{selectedTicket.subject}</h3>
                                <p className="text-[9px] text-slate-500">{STATUS_STYLES[selectedTicket.status]?.label || selectedTicket.status}</p>
                            </div>
                        </div>
            ...
            {selectedTicket && selectedTicket.status !== 'closed' && (
                <div className="border-t border-white/5 p-4 flex items-center gap-2">
                    ...
                    />
                    <button onClick={sendReply} disabled={!chatInput.trim() || sending}
    ...
    if (embedded) {
        return <div className="flex flex-col h-full overflow-hidden">{ticketsContent}</div>;
    }
            ...
            {isOpen && (
                ...
                >
                    <motion.div
                        ...
                        className="w-full max-w-lg max-h-[80vh] rounded-3xl overflow-hidden flex flex-col bg-[#0c1222] border border-white/10"
                    >
