...
export default function StepVision({ data, onChange }: Props) {
  ...
  return (
    <div className="arco-section arco-animate-in">
      ...
      <p className="arco-section-desc">Quasi finito! Queste risposte ci aiuteranno a personalizzare l&apos;evento. I campi con l&apos;asterisco (*) sono obbligatori.</p>

      <div className="arco-field">
        <label className="arco-label">Se potessi automatizzare una cosa del tuo lavoro, quale sarebbe? <span className="arco-label-hint">(opzionale)</span></label>
      ...
      <div className="arco-field">
        <label className="arco-label">Qual è l&apos;attività che ti ruba più tempo durante la giornata? <span className="arco-label-hint">(opzionale)</span></label>
      ...
      <div className="arco-field">
        <label className="arco-label">Se l&apos;AI potesse darti un superpotere lavorativo, quale vorresti? 🦸 <span className="arco-label-hint">(opzionale)</span></label>
      ...
      <div className="arco-field">
        <label className="arco-label">Cosa ti incuriosisce di più? <span className="arco-label-hint">(opzionale, seleziona tutte)</span></label>
